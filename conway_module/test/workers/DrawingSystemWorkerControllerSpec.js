...
describe('DrawingSystemWorkerController', function(){
  ...
  describe('Command Routing', function () {
    ...
    it('should toggle cell', function(){
      expect(controller.drawingSystem.getCells().find((c) => c.location.row === 7 && c.location.col === 14)).to.be.undefined;
      controller.process({
      ...
      expect(controller.drawingSystem.getCells().find((c) => c.location.row === 7 && c.location.col === 14)).to.not.be.undefined;
    });
